...
_params = ParamGrid(
    [
        ...
        #         ["sr_transformer", "concat_smoothed"],
        #         ["sr_transformer", "none"],
        #     ),
        # ),
...
# python -m sample_factory.launcher.run --backend=slurm --slurm_workdir=./slurm_grid --slurm_gpus_per_job=0 --slurm_cpus_per_gpu=50 --slurm_sbatch_template=./training_template.sh --pause_between=1 --slurm_print_only=False --run=sf_workingdir.dmlab.experiments.Hipposlam_batch_run_transformer_decoder_new --slurm_partition=cpu --slurm_timeout=40:10:00
